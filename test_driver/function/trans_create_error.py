...
def run_test():
    try:
        ...
        logging.info("Lưu mà không nhập số tiền")
        ...
        logging.info("Lưu với số tiền 350k nhưng ko chọn danh mục")
        input_text(driver, "Amount Input", "350000")
        time.sleep(3)
        click_element(driver, "Save")
        time.sleep(5)

        logging.info("Lưu với số tiền 350k, có danh mục nhưng ngày trong tương lai")
        input_text(driver, "Amount Input", "350000")
        time.sleep(5)
        ...
        # # ngày phải đúng hnay
        # logging.info("Chọn lại ngày 2/4/2025")
        # driver.find_element(by=AppiumBy.ACCESSIBILITY_ID, value="1/4/2025").click()
        # time.sleep(5)
        # driver.find_element(by=AppiumBy.ACCESSIBILITY_ID, value="2, Tuesday, April 2, 2025").click()
        # time.sleep(5)
